...
for i in range(len(n_neuron_L1_set)):
    ...
    # plt.scatter(arg_max_perc_act_L1[i], arg_max_perc_act_L2[i], s=20, color=colors[i])
...
for i in range(len(n_neuron_L1_set)):
    ...
    # plt.scatter(arg_max_perc_act_L1_info[i], arg_max_perc_act_L2_info[i], s=10, color=colors[i])
    # # plt.text(arg_max_perc_act_L1_info[i], arg_max_perc_act_L2_info[i], str(n_neuron_L1_set[i]*4), fontsize=12, ha='right', va='bottom')
...
for i in range(len(n_neuron_L1_set)):
    ...
    # plt.scatter(arg_max_perc_act_L1_mixed[i], arg_max_perc_act_L2_mixed[i], s=10, color=colors[i])
    # # plt.text(arg_max_perc_act_L1_mixed[i], arg_max_perc_act_L2_mixed[i], str(n_neuron_L1_set[i]*4), fontsize=12, ha='right', va='bottom')
